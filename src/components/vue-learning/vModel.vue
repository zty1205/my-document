    ...
    <div class="body">
      <div class="block">
        ...
        <div class="inline-block-demo">
          ...
          <input type="checkbox" id="checkbox" value='checked' v-model="checkbox1">
        ...
        <div class="inline-block-demo">
          ...
          <input type="checkbox" id="checkbox1" value="one" v-model="mCheckbox">
          <label for="checkbox1">one</label>
          <input type="checkbox" id="checkbox2" value="two" v-model="mCheckbox">
          <label for="checkbox2">two</label>
          <input type="checkbox" id="checkbox3" value="three" v-model="mCheckbox">
